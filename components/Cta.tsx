...
export default function Cta({ scrollTo }: CtaProps) {
  ...
  return (
    <section
      id="cta"
      className="relative w-full min-h-[580px] sm:min-h-[860px] lg:min-h-[920px] flex items-center justify-center select-none py-16 sm:py-28 lg:py-36 overflow-hidden bg-[#04040c]"
    >
      {/* Deep radial bg */}
      ...
      {/* Central glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[520px] sm:h-[520px] bg-purple-600/20 rounded-full blur-[100px] sm:blur-[140px] pointer-events-none z-0" />
      ...
      <div className="hidden sm:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:w-[800px] sm:h-[800px] lg:w-[1080px] lg:h-[1080px] rounded-full pointer-events-none z-10">
        {creatorCards.map((creator, idx) => {
          ...
          const radius = 37.5; // Positions all cards completely inside the outer circle on desktop
      ...
      <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-sm sm:max-w-3xl mx-auto gap-4 sm:gap-6">
        ...
        {/* Top Badge */}
        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3.5 py-1 rounded-full bg-purple-500/10 border border-purple-400/20 text-purple-300 text-[10px] sm:text-[11px] font-bold tracking-wider uppercase backdrop-blur-md">
